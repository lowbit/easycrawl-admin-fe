...
import { Activity, Package, Code2, Brain } from 'lucide-react';
              ...
              <div className="flex items-center">
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Start using the application to see activity here
                  </p>
                </div>
              </div>
            </div>
          ...
          <CardContent>
            <div className="grid gap-4">
              <div className="flex items-center gap-4 rounded-lg border p-4">
                ...
                <div className="space-y-1">
                  <p className="text-sm font-medium leading-none">Add Product</p>
                  <p className="text-sm text-muted-foreground">
              ...
              <div className="flex items-center gap-4 rounded-lg border p-4">
                ...
                <div className="space-y-1">
                  <p className="text-sm font-medium leading-none">Start Crawler</p>
                  <p className="text-sm text-muted-foreground">
                    Begin a new crawling job
                  </p>
                </div>
              </div>
            </div>
